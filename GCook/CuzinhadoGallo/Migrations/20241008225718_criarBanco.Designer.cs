...
namespace CuzinhadoGallo.Migrations
{
    ...
    [Migration("20241008225718_criarBanco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.Comentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.Ingrediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.Receita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.ReceitaIngrediente", b =>
                {
                    b.Property<int>("ReceitaId")
                        .HasColumnType("int")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.Usuario", b =>
                {
                    b.Property<string>("UsuarioId")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataNascimento = new DateTime(2007, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ddf093a6-6cb5-4ff7-9a64-83da34aee005",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7bdc452c-5439-4c7e-9b5d-f502b047c685",
                            Email = "admin@gcook.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GCOOK.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEANE0NilPVqu+o6mKFOvkNW2x71jCBjIc3wdu0WE8JtcPe0hHpQsIUn3QtpTsf9+0Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "72a665be-bebc-445e-b5de-b7ee426c6e03",
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.Comentario", b =>
                {
                    b.HasOne("CuzinhadoGallo.Models.Receita", "Receita")
                        .WithMany()
                        .HasForeignKey("ReceitaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CuzinhadoGallo.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.Receita", b =>
                {
                    b.HasOne("CuzinhadoGallo.Models.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("CuzinhadoGallo.Models.ReceitaIngrediente", b =>
                {
                    b.HasOne("CuzinhadoGallo.Models.Ingrediente", "Ingrediente")
                        .WithMany("Receitas")
